...
RandomAppHelper::RandomAppHelper (std::string protocol, Address address)
{
  m_factory.SetTypeId ("ns3::RandomGenerator");
...
int64_t
RandomAppHelper::AssignStreams (NodeContainer c, int64_t stream)
{
...
void 
RandomAppHelper::SetConstantRate (DataRate dataRate, uint32_t packetSize)
{
