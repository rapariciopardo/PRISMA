...
RandomGenerator::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::RandomGenerator")
    ...
    .AddAttribute ("DataRate", "The data rate in on state.",
                   ...
                   MakeDataRateAccessor (&RandomGenerator::m_cbrRate),
                   MakeDataRateChecker ())
    ...
    .AddAttribute ("OnTime", "A RandomVariableStream used to pick the duration of the 'On' state.",
                   ...
                   MakePointerAccessor (&RandomGenerator::m_onTime),
                   MakePointerChecker <RandomVariableStream>())
    .AddAttribute ("OffTime", "A RandomVariableStream used to pick the duration of the 'Off' state.",
                   StringValue ("ns3::ConstantRandomVariable[Constant=1.0]"),
                   MakePointerAccessor (&RandomGenerator::m_offTime),
                   MakePointerChecker <RandomVariableStream>())
    .AddAttribute ("MaxBytes", 
                   ...
                   UintegerValue (0),
                   MakeUintegerAccessor (&RandomGenerator::m_maxBytes),
    ...
    .AddTraceSource ("Tx", "A new packet is created and is sent",
                     MakeTraceSourceAccessor (&RandomGenerator::m_txTrace),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("TxWithAddresses", "A new packet is created and is sent",
                     MakeTraceSourceAccessor (&RandomGenerator::m_txTraceWithAddresses),
...
void 
RandomGenerator::SetMaxBytes (uint64_t maxBytes)
{
...
Ptr<Socket>
RandomGenerator::GetSocket (void) const
{
  NS_LOG_FUNCTION (this);
  return m_socket;
}
...
int64_t 
RandomGenerator::AssignStreams (int64_t stream)
{
...
void
RandomGenerator::DoDispose (void)
{
  NS_LOG_FUNCTION (this);
...
// Application Methods
void RandomGenerator::StartApplication () // Called at time specified by Start
{
  NS_LOG_FUNCTION (this);
  ...
  if (!m_socket)
    {
      ...
      m_socket->SetConnectCallback (
        MakeCallback (&RandomGenerator::ConnectionSucceeded, this),
        MakeCallback (&RandomGenerator::ConnectionFailed, this));
    }
...
void RandomGenerator::StopApplication () // Called at time specified by Stop
{
  ...
  if(m_socket != 0)
    ...
    {
      NS_LOG_WARN ("RandomGenerator found null socket to close in StopApplication");
    }
}

void RandomGenerator::CancelEvents ()
{
  NS_LOG_FUNCTION (this);
...
// Event handlers
void RandomGenerator::StartSending ()
{
  NS_LOG_FUNCTION (this);
...
void RandomGenerator::ConnectionSucceeded (Ptr<Socket> socket)
{
  NS_LOG_FUNCTION (this << socket);
  m_connected = true;
}

void RandomGenerator::ConnectionFailed (Ptr<Socket> socket)
{
  NS_LOG_FUNCTION (this << socket);
}
