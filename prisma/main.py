...
def main():
    ...
    while threading.active_count() > params["numNodes"] * (1+ params["train"]):
        ...
        if params["train"] == 1:
            ...
            print("Time = ", Agent.curr_time, "Overal injected packets = ", Agent.sim_injected_packets, "Overal delivered packets = ", Agent.sim_delivered_packets, "Overal lost packets = ", Agent.sim_lost_packets, "Overlay buffered packets = ", Agent.sim_buffered_packets)
