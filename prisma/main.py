...
def main():
    ...
    test_results_file_name = f'{params["logs_parent_folder"]}/_tests_overlay_11/prio_{params["prioritizedReplayBuffer"]}_underlayTraff_{params["activateUnderlayTraffic"]}_{params["agent_type"]}_{params["signaling_type"]}_{params["signalingSim"]}_fixed_rb_{params["replay_buffer_max_size"]}_sync{int(1000*params["sync_step"])}ms_ratio_{int(100*params["sync_ratio"])}_overlayPackets_{params["nPacketsOverlay"]}_loadTrain_{int(100*params["load_factor_trainning"])}_load_{int(100*params["load_factor"])}.txt'
    train_results_file_name = f'{params["logs_parent_folder"]}/_train_overlay_11/prio_{params["prioritizedReplayBuffer"]}_underlayTraff_{params["activateUnderlayTraffic"]}_{params["agent_type"]}_{params["signaling_type"]}_{params["signalingSim"]}_fixed_rb_{params["replay_buffer_max_size"]}_sync{int(1000*params["sync_step"])}ms_ratio_{int(100*params["sync_ratio"])}_overlayPackets_{params["nPacketsOverlay"]}_loadTrain_{int(100*params["load_factor_trainning"])}_load_{int(100*params["load_factor"])}.txt'
