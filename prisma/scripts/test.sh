...
for j in ${array[@]}
	...
	python3 main.py --simTime=60 \
		...
		--train=0 \
		--session_name="test_abilene_ideal_ts_0_03_batch_512_lr_1e-3_gamma_0_95_final_eps_0_01_load_$res1"\
		...
		--load_path=examples/abilene/saved_models/train_abilene_ideal_ts_0_03_batch_512_lr_1e-3_gamma_0_95_final_eps_0_01/iteration1_episode1 \
		--save_models=0 \
		--start_tensorboard=0 \
		--load_factor=$j
	counter=$((counter+1))
