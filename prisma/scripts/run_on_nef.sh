...
python3 main.py \
	...
	--train=1 \
	--agent_type=$4 \
	--session_name="off___seg_new_t300_7k_ma_in_train_new_overlay_obs_in_bytes_fixed_$9_real_delay_$4_$5_ts_0_01_seed_$2_prio_${10}_traff_mat_$3_rb_size_$7_batch_512_lr_1e-3_gamma_1_final_eps_0_01_load_${res1}_refreshRate_$6_underlayTraff_${12}_sync_$1_loss_x11_sp_init" \
	--signaling_type=$5 \
...
for j in ${array[@]}
	...
	python3 main.py \
		...
		--prioritizedReplayBuffer=${10} \
        --activateUnderlayTraffic=${12} \
		--load_path=examples/$9/saved_models/off_seg_new_t300_7k_ma_in_train_new_overlay_obs_in_bytes_fixed_$9_real_delay_$4_$5_ts_0_01_seed_$2_prio_${10}_traff_mat_$3_rb_size_$7_batch_512_lr_1e-3_gamma_1_final_eps_0_01_load_${res1}_refreshRate_$6_underlayTraff_${12}_sync_$1_loss_x11_sp_init/iteration1_episode1 \
		--load_factor_trainning=${11} \
		--load_factor=$j
