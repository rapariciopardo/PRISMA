...
python3 main.py \
	...
	--train=1 \
	--agent_type=$4 \
	--session_name="train_test_v29_overlay_obs_in_bytes_fixed_$9_real_delay_$4_$5_$6_ts_0_01_seed_$2_traff_mat_$3_rb_size_$7_batch_512_lr_1e-3_gamma_1_final_eps_0_01_load_40_sync_$1_loss_x11_sp_init" \
	--signaling_type=$5 \
...
#		--train=0 \
#		--seed=$2 \
#		--session_name="test_new_$9_real_delay_$4_$5_real_$6_rb_$7_sync_step_$1_variation_mat_$3_seed_$2_load_$res1" \
#		--signaling_type=$5 \
#		--agent_type=$4 \
#		--logs_parent_folder=examples/$9/ \
#		--traffic_matrix_index=$3 \
...
#		--replay_buffer_max_size=$7 \
#		--max_out_buffer_size=16260 \
#		--load_path=examples/$9/saved_models/train_overlay_obs_in_bytes_fixed_$9_real_delay_$4_$5_$6_ts_0_01_seed_$2_traff_mat_$3_rb_size_$7_batch_512_lr_1e-3_gamma_1_final_eps_0_01_load_40_sync_$1_loss_x11_sp_init/iteration1_episode1 \
#		--load_factor=$j
#
