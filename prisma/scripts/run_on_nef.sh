...
for j in ${array[@]}
	...
	python3 main.py \
		...
		--train=0 \
		--seed=200 \
		--session_name="t_off_corr_11n${13}_buf_1x_ma_in_test_new_$9_real_delay_$4_$5_real_rb_$7_sync_step_$1_variation_mat_$3_seed_$2_prio_${10}_load_$res2" \
		--signaling_type=$5 \
		--agent_type=$4 \
		--logs_parent_folder=examples/$9/ \
		...
		--load_path=examples/$9/saved_models/ping_corr_no_norm_11n${13}_buf_1x_ma_in_train_overlay_obs_fixed_$9_real_delay_$4_$5_ts_0_01_seed_$2_traff_mat_$3_rb_size_$7_batch_512_lr_1e-3_gamma_1_final_eps_0_01_load_${res1}_refreshRate_$6_underlayTraff_${12}_sync_$1_loss_x11_sp_init/iteration1_episode1 \
		--load_factor_trainning=${11} \
		--load_factor=$j
