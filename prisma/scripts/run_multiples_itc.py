...
dqn_models = [""]
experiment_name = "ITC_NN_size_variations_experiment_snapshot"
...
explorations = [["vary", 1.0, 0.01],
                ["fixed", 0.1, 0.1]]
smart_explorations = [0,1]
ping_freq = 10000
mv_avg_interval = 100
train_duration = 60
test_duration = 20
max_output_buffer_sizes = [16260,]
loss_aware_values = [1,0]
train_load = 0.4
                                    ...
                                    for sync_step in sync_steps:
                                            ...
                                            for test_load in test_loads:
                                                python_command = generate_command(seed=seed,
                                                                                   ...
                                                                                   snapshot_interval=0,
                                                                                   smart_exploration=smart_exploration,
                                                                                   load_path=f"examples/{topology_name}/results/{experiment_name}/saved_models/{session_name}/final",
                                                                                   d_t_load_path=f"examples/{topology_name}/results/{experiment_name}/saved_models/{session_name}/final")
