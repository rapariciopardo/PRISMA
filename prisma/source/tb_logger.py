...
def stats_writer_test(summary_writer_results_path, Agent):
    ...
    with summary_writer_results.as_default():
        ...
        tf.summary.scalar(f'test_global_loss_rate', Agent.sim_global_dropped_packets/max(1, Agent.sim_global_injected_packets), step=int(Agent.load_factor*100))
        tf.summary.scalar(f'test_overlay_loss_rate', Agent.sim_dropped_packets/max(1, Agent.sim_injected_packets), step=int(Agent.load_factor*100))
