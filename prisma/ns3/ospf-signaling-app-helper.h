 ...
 */
#ifndef OspfSIGNALING_APP_HELPER_H
#define OspfSIGNALING_APP_HELPER_H
...
/**
 * \ingroup onoff
 * \brief A helper to make it easier to instantiate an ns3::OspfSignalingGeneratorApplication 
 * on a set of nodes.
 */
class OspfSignalingAppHelper
{
public:
  /**
   * Create an OspfSignalingAppHelper to make it easier to work with OspfSignalingGeneratorApplications
   *
   ...
   *        to.
   */
  OspfSignalingAppHelper (std::string protocol, Address address);
  ...
  void SetNNeighbors(uint32_t n_neighbors);

  void SetSourceDestInterface (uint32_t src, uint32_t dest, uint32_t interface);

  /**
   * Install an ns3::OspfSignalingGeneratorApplication on each node of the input container
   * configured with all the attributes set with SetAttribute.
   *
   * \param c NodeContainer of the set of nodes on which an OspfSignalingGeneratorApplication 
   * will be installed.
  ...
  /**
   * Install an ns3::OspfSignalingGeneratorApplication on the node configured with all the 
   * attributes set with SetAttribute.
   *
   * \param node The node on which an OspfSignalingGeneratorApplication will be installed.
   * \returns Container of Ptr to the applications installed.
   */
   ...
   * attributes set with SetAttribute.
   *
   * \param nodeName The node on which an OspfSignalingGeneratorApplication will be installed.
   * \returns Container of Ptr to the applications installed.
   */
...
#endif /* OspfSIGNALING_APP_HELPER_H */
