  ...
  if (m_maxBytes == 0 || m_totBytes < m_maxBytes)
    {
      ...
      ev_rate->SetAttribute ("Mean", DoubleValue (bits/static_cast<double>(m_avgRate.GetBitRate ())));
      ...
      double delay = ev_rate->GetValue(); // bits/ static_cast<double>(m_avgRate.GetBitRate ());
