...
class Agent():
    ...
    def _take_action(self, obs):
        ...
        #if(action != self.neighbors.index(nx.shortest_path(Agent.G, self.index, obs[0])[1])):
        #    #print(self.update_eps)
        #    print(self.index, "     ", obs[0], "      ", action, "      ", self.neighbors.index(nx.shortest_path(Agent.G, self.index, obs[0])[1]))
        return action
